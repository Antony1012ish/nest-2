...
@app.post("/register/")
def register_student(registration: schemas.StudentClassRegister, db: Session = Depends(get_db)):
    return crud.register_student_to_class(db, registration.student_id, registration.class_id)
